    ...
    <section id="about" className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-24 mb-24">
          ...
          >
            <p>
              CASTINGENERGY는 단순한 매칭을 넘어 브랜드의 정체성을 시각화합니다. 
              20년 이상의 전문 커리어를 바탕으로 캠페인의 에너지를 극대화할 
              최적의 인재를 제안하며, 각 브랜드가 가진 고유의 가치를 발견합니다.
            </p>
            <p>
              우리의 목표는 파트너사가 시장에서 독보적인 존재가 되는 것입니다. 
              패션, 뷰티, 라이프스타일을 아우르는 독보적인 네트워크를 통해 
              프로젝트에 에너지를 더하겠습니다.
            </p>
          </motion.div>
        </div>
